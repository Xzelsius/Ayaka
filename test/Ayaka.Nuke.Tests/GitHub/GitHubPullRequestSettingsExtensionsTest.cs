...
public sealed class GitHubPullRequestSettingsExtensionsTest
{
    ...
    [Fact]
    public void Does_validate_settings_Head_null()
    {
        var settings = new GitHubPullRequestSettings()
        ...
        action
            ...
            .WithParameterName(nameof(GitHubPullRequestSettings.Head));
    }

    [Fact]
    public void Does_validate_settings_Head_empty()
    {
        var settings = new GitHubPullRequestSettings()
            .SetRepositoryOwner("owner")
            .SetRepositoryName("name")
    ...
    [Fact]
    public void Does_validate_settings_Base_null()
    {
        var settings = new GitHubPullRequestSettings()
            .SetRepositoryOwner("owner")
            .SetRepositoryName("name")
        ...
        action
            .Should()
            .Throw<ArgumentNullException>()
            .WithParameterName(nameof(GitHubPullRequestSettings.Base));
    }

    [Fact]
    public void Does_validate_settings_Base_empty()
    {
        var settings = new GitHubPullRequestSettings()
            .SetRepositoryOwner("owner")
            .SetRepositoryName("name")
    ...
    [Fact]
    public void Does_validate_settings_Title_null()
    {
        var settings = new GitHubPullRequestSettings()
            .SetRepositoryOwner("owner")
            .SetRepositoryName("name")
        ...
        action
            .Should()
            .Throw<ArgumentNullException>()
            .WithParameterName(nameof(GitHubPullRequestSettings.Title));
    }

    [Fact]
    public void Does_validate_settings_Title_empty()
    {
        var settings = new GitHubPullRequestSettings()
            .SetRepositoryOwner("owner")
            .SetRepositoryName("name")
