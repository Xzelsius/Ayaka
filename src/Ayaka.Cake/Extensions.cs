...
/// <summary>
///     Various extension methods for better experience when creating Cake Frosting builds.
/// </summary>
public static class Extensions
{
    /// <summary>
    ///     Invokes the <paramref name="configurator" /> if the <paramref name="condition" /> is <c>true</c>.
    /// </summary>
    ...
    /// <param name="configurator">The method to execute if <paramref name="condition" /> is <c>true</c>.</param>
